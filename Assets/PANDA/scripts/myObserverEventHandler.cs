...
public class myObserverEventHandler : MonoBehaviour
{
    ...
    public ObserverBehaviour mObserverBehaviour; //protected 
    protected TargetStatus mPreviousTargetStatus = TargetStatus.NotObserved; //protected 
    ...
    void OnObserverStatusChanged(ObserverBehaviour behaviour, TargetStatus targetStatus)
    {
        ...
        /*if(targetStatus.Status == "TRACKED")
        {
            globall.paintname=mObserverBehaviour.TargetName.ToString();
        }*/
    ...
    public virtual void HandleTargetStatusChanged(Status previousStatus, Status newStatus)
    {
    ...
    {
        globall.page = 1 ;
        Debug.Log(mObserverBehaviour.TargetName);
        globall.paintname=mObserverBehaviour.TargetName.ToString();
        if (mObserverBehaviour)
        {
